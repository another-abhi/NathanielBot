...
def test_name2():
    ...
    assert a=="Hello, my name is Nathaniel."or a=="I'm Nathaniel" or a=="You can call me Nathaniel"
def test_canteen2():
    assert response("i am standing in class",show_details=True)=="You are in the building right now.The ccf is at the first floor and the canteen ath the ground floor"

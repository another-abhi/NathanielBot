...
\thispagestyle{empty}
\newcommand*{\plogo}{
    \includegraphics[width=0.5\textwidth]{C:/Users/Another/PROJECT/ProjectReport/label.png} % copy path of your image in brackets
    \iffalse
      \includegraphics[width=0.5\textwidth]{C:/Users/Another/PROJECT/ProjectReport/label.png} % copy path of your image in brackets
    \fi
}
...
\textbf{
{\LARGE MODULAR CHATBOT}\\[\baselineskip] % Title
}
...
%[\baselineskip]
\textbf{APRIL, 2018}\\[\baselineskip]}\par % Publisher
\newpage
\endgroup}
